...
contract NFT is ERC721Enumerable, Ownable
{
    ...
    uint256 public allowMintingOn; // Unix timestamp
    ...
    function mint(uint256 _mintAmount) public payable
    {
        ...
        require(block.timestamp >= allowMintingOn, "minting time not reached");

        // Must mint at least one token
        require(_mintAmount > 0, "must mint at least 1 token");

        // Require enough payment
        require(msg.value >= cost * _mintAmount, "not enough Ether to mint NFTs");
